...
## Demo 1: Use Menu Items of Blue Web
...
<label
    ...
    <input id="actionsDemoMenuItemsRange" type="range" min="50" max="1200" value="460" />
</label>

<script>
    window.actionsDemoMenuItemsResponse = null
    document.addEventListener("DOMContentLoaded", () => {
        actionsDemoMenuItemsResponse = blueWeb.actions.init(document.getElementById("actionsDemoMenuItems"))

        actionsDemoMenuItemsRange.addEventListener("input", ({ target }) => {
            actionsDemoMenuItems.style.width = `${target.value}px`
        })
    })
</script>
```
...
<Grab items={[{ src: "@/dist/styles/_actions.css" }, { src: "@/src/js/actions.ts" }]} />
