...
```html use:RenderBlock
<bl-input-splitted id="disabledInputSplitted" length="4" disabled></bl-input-splitted>
<button type="button" class="btn blue-btn-soft-secondary" onclick="toggleDisabled()">Toggle disabled</button>

<script>
    function toggleDisabled() {
        const el = document.getElementById("disabledInputSplitted")
