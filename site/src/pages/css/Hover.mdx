...
```html use:RenderBlock
<div class="blue-bg-hover">Hover to change background color</div>
```

With CSS property `--blue-hover-bg` you can set the background color on hover:

```html use:RenderBlock
<div class="blue-bg-hover" style="--blue-hover-bg: var(--bs-primary)">Hover to change background color</div>
```

<Grab items={[{ src: "@/dist/styles/_hover.scss" }]} />
